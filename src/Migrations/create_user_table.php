...
class CreateUserTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('user', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('user_type')->default(1)->comment('用户类型：1.普通用户、2.货运司机、3.企业用户，4.专送员');
            ...
            $table->tinyInteger('status')->default(0)->comment('账号状态。-1.禁用、0.待认证、1、正常、2.实名认证、3.高级认证(已认证专属身份，如司机资料)');
